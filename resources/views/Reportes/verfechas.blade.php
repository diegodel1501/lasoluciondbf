...
{!! Form::open(array('url'=>'fechas','id'=>'buscarfechas','method'=>'POST','autocomplete'=>'off')) !!}
	{{Form::token()}}
<div class="row">
   ...
   Por fecha de entrega
	...
	<div class="col-md-3 col-xs-12">
								<div class="form-group">
									...
									<div class="input-group date" data-provide="datepicker" data-date-format="mm/dd/yyyy">
										<input class="date form-control" readonly="true"  type="text" id="datepickerDESDE" required name="fechadesde">
	...
	<div class="col-md-3 col-xs-12">
								<div class="form-group">
									...
									<div class="input-group date" data-provide="datepicker" data-date-format="mm/dd/yyyy">
										<input class="date form-control" readonly="true"  type="text" id="datepickerHASTA" required name="fechahasta">
										<div class="input-group-addon">
											<i class="fa fa-circle-o"></i>
										</div>
									</div>
